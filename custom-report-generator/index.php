<?php
$site_url = 'http://localhost/osh-system';
...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet"
          href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/bootstrap/css/bootstrap.css"/>

    <link rel="stylesheet"
          href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/font-awesome/css/font-awesome.css"/>
    <link rel="stylesheet"
          href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/magnific-popup/magnific-popup.css"/>
    <link rel="stylesheet"
          href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.css"/>

    <!-- Specific Page Vendor CSS -->
    <link rel="stylesheet" href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery-ui/jquery-ui.css"/>
    <link rel="stylesheet"
          href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery-ui/jquery-ui.theme.css"/>
    <link rel="stylesheet"
          href="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/bootstrap-multiselect/bootstrap-multiselect.css"/>
...
<header class="panel-heading" style="background:transparent;">
    <div class="row" style="background:#fdfdfd;padding:20px;border-radius:10px;">
        ...
        <img src="<?php echo $site_url;?>/public/hebert_admin/images/logo_swelab_transparent_horizontal.png"
             style="max-height:40px;height:100%;width:auto;margin-right:25px;">
        <img src="<?php echo $site_url . '/storage/app/public/' . $x_logors;?>"
             style="max-height:40px;height:100%;width:auto;position:absolute;right:0;padding-right:20px;">
    </div>
</header>
<header class="panel-heading">
    <div class="row">
        <h2 class="panel-title" style="padding-left:15px;">
            ...
            <img alt="<?php echo $x_id;?>" src="barcode_generator/barcode.php?text=<?php echo $x_id;?>"
                 style="position:absolute;right:0;padding-right:10px;top:0;padding-top:10px;"/>
        </h2>
...
<div class="col-md-8">
    ...
    <?php
    $resultDetail = pg_query($dbconn, "SELECT tab_lab_detil.*, tab_kdlab.nama as nama_kdlab FROM tab_lab_detil
    JOIN tab_kdlab ON tab_lab_detil.id_lab = tab_kdlab.id
     where id_master = '" . $_GET['lid'] . "' ORDER BY id_lab ");
    if (!$resultDetail) {
        echo "An error occurred.\n";
        exit;
    }
    $arrDetail = pg_fetch_all($resultDetail);
    ?>
    <table class="table table-bordered table-responsive">
        ...
        foreach ($arrDetail as $array) {
            ...
            echo "<td>" . $array['nama_kdlab'] . "</td>";
            if ($array['flag'] == "5") {
                echo '<td style="color:purple;"><b>' . $array['hasil'] . '</b> *</td>';
            } elseif ($array['flag'] == "4") {
                echo '<td style="color:red;"><b>' . $array['hasil'] . '</b> *</td>';
            } else {
                echo '<td style="color:green;"><b>' . $array['hasil'] . '</b></td>';
            }
            echo "<td>" . $array['n_rujukan'] . "</td>";
            echo "<td>" . $array['satuan'] . "</td>";
            echo "<td></td>";
            $i++;
        }
        ?>
...
<script>
    ...
    ?>
<p>Data histogram tidak ditemukan</p>
    <?php
}
?>
...
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery-browser-mobile/jquery.browser.mobile.js"></script>
...
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/magnific-popup/jquery.magnific-popup.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery-placeholder/jquery-placeholder.js"></script>

<!-- Specific Page Vendor -->
<script src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery-ui/jquery-ui.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqueryui-touch-punch/jqueryui-touch-punch.js"></script>
<!-- 		<script src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery-appear/jquery-appear.js"></script> -->
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/bootstrap-multiselect/bootstrap-multiselect.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.js"></script>
...
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqvmap/maps/continents/jquery.vmap.africa.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqvmap/maps/continents/jquery.vmap.asia.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqvmap/maps/continents/jquery.vmap.australia.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqvmap/maps/continents/jquery.vmap.europe.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js"></script>
<script
    src="<?php echo $site_url;?>/public/hebert_admin/assets/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js"></script>
